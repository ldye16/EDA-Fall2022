...
> Answer: I learned about the various ways you can portray a dataset and some of the reasons you may choose one visual over another. 


How can multiple options for data exploration inform our understanding of our data?

> Answer: Each visualization will allow you to learn something new about the data. For example, when we potted the data with datetime, we revealed a sizable gap in the data. 
...
> Answer: We saw that when you plot height with discharge there is a slowing down of the curve. This is do to a widening of the stream the higher up the stream bank you go. This means that, at high volumes, an increase in discharge may not increase the height as much as if the same discharge increased at a lower stream height. 
