...
huc8_sf_wind <- merge(x = NCHUC8_sf, 
                      y = HUC8_wind_sf,
                      by.x = "HUC_8",
                      by.y = "HUC_8")
...
huc8_sf_utm <-     st_transform(NCHUC8_sf, crs = 26917)
...
huc8s_WGS84 <- st_transform(NCHUC8_sf,c=4326)
...
leaflet() %>% addTiles() %>% 
  ...
  addPolygons(data=NCHUC8_sf,weight=1)
```
