...
SurfaceTemperature <- filter(PeterPaul.chem.nutrients, depth == 0)

plot1 <- 
  ggplot(SurfaceTemperature, aes(x=daynum, y=temperature_C)) +
...
plot4 <- 
  ggplot(EPAair, aes(x=Year, y=PM2.5, color = year))+
  geom_point()
print(plot4)
