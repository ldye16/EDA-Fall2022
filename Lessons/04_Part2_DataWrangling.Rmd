...
colnames(NTL.nutrient.data.PeterPaul.subset)
colnames(NTL.nutrient.data.PeterPaul.subset2)
...
count(NTL.nutrient.data.PeterPaul.gathered$nu, nutrient)
...
LitterFiles #start by specifying a path to where are the files you want to bind are. Then use patters to speficy what the the files you want to read are. You want to use the full names are of the files. 
