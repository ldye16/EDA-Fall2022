...
#I was not sure what exactly to put here so I simply asked (mean>median), which came back FALSE. This checks out since median and mean are equal to each other. 
(mean>median)
